...
export default function CartPage() {
  ...
  // ✅ Memoiza el cálculo del total para evitar re-renders innecesarios
  ...
  // ✅ Animaciones adaptativas según preferencias del usuario
  ...
  return (
    <div className="bg-black min-h-screen pt-24 pb-16 relative overflow-hidden">
      ...
      {/* ✅ Glows con will-change optimizado */}
      <div className="absolute top-1/4 -left-32 w-64 md:w-96 h-64 md:h-96 bg-purple-600/10 rounded-full blur-3xl pointer-events-none" style={{ willChange: 'auto' }} />
      <div className="absolute bottom-1/4 -right-32 w-64 md:w-96 h-64 md:h-96 bg-pink-600/10 rounded-full blur-3xl pointer-events-none" style={{ willChange: 'auto' }} />
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl relative z-10">
        ...
        {items.length === 0 ? (
          ...
          >
            {/* ✅ Background number con rendering optimizado */}
            <div 
            ...
            {/* ✅ Animación del emoji simplificada */}
            <motion.div
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
              ...
              {items.map((it, index) => (
                ...
                >
                  ...
                  <div className="flex gap-4 md:gap-6 relative z-10">
                    {/* ✅ Imagen optimizada con sizes correctos */}
                  ...
                  {/* ✅ Shimmer effect solo en desktop */}
            ...
            <div className="lg:col-span-1">
              ...
              >
                {/* ✅ Glow decorativo optimizado */}
                <div className="absolute -top-20 -right-20 w-32 md:w-40 h-32 md:h-40 bg-purple-600/10 rounded-full blur-3xl pointer-events-none" style={{ willChange: 'auto' }} />

                <div className="relative z-10">
                  <h3 className="text-white font-black text-xl md:text-2xl mb-6 tracking-wider flex items-center gap-3">
                    <span>RESUMEN</span>
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between text-white/50 text-xs md:text-sm">
                      <span>Envío</span>
                      <span className="text-[10px] md:text-xs">En checkout</span>
                    </div>
